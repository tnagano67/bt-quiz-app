            ...
            <table className="w-full text-xs">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-2 py-1 text-left text-gray-500">学年</th>
                  <th scope="col" className="px-2 py-1 text-left text-gray-500">組</th>
                  <th scope="col" className="px-2 py-1 text-left text-gray-500">番号</th>
